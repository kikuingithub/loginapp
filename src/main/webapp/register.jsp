<%@page contentType="text/html" pageEncoding="UTF-8"%> <!DOCTYPE html>
 ...
 <form method="post" action="userRegistration.jsp"> 
	<center> 
		...
		<thead> <tr> <th colspan="2">Register with your details</th> </tr> </thead> 
		...
		<tr> <td><input type="submit" value="Sign Up" /></td> <td><input type="reset" value="Reset" /></td> </tr>
		<tr> <td colspan="2"> If Already registered!! <a href="index.jsp">Login Here</a></td> </tr>
		</tbody> 
		</table>
	</center>
 </form>
